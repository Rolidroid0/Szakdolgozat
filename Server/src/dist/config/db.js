...
var connectToDb = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, mongoose_1.default.connect(process.env.MONGODB_URI || 'mongodb+srv://budairoland0:gmzclLU5oeVUBZxv@clustermain.uueri7j.mongodb.net/BoardGame?retryWrites=true&w=majority&appName=ClusterMain')];
            case 2:
                connection = _a.sent();

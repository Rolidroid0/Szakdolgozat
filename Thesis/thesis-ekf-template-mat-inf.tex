...
\begin{document}
	...
	\Aref{winrate} oszlopdiagram az epizódok során mért \textbf{nyertes játékok arányát mutatja 10 epizódonként}, külön a két tanítási eredményfájl alapján. Baloldalt a rue240, jobboldalt pedig az eredmenyek fájl adatai láthatók.
	...
	\Aref{mozgoatlag} ábra egy \textbf{mozgóátlagos ábrázolást} mutat, amelyből jól látható, hogy a rue240 (bal) esetében a teljesítmény bár továbbra is szór, összességében valamelyest javul.
